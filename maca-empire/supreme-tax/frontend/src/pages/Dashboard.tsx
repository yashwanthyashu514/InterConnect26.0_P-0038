...
const AGENT_LIST = [
  ...
  { id: 'A2', name: 'Banking & Credit' },
  { id: 'A3', name: 'Notice & Disputes' },
  { id: 'A4', name: 'Payroll & HR' },
  { id: 'A5', name: 'Corporate Counsel' },
  { id: 'A6', name: 'Voice CA' },
  { id: 'A7', name: 'Deal Reviewer' },
  { id: 'A8', name: 'Filing Ops' },
  { id: 'A12', name: 'Forensic Audit' },
  { id: 'A13', name: 'Trade & Forex' },
  { id: 'A21', name: 'DPDP Shield' },
  { id: 'A22', name: 'CryptoTax Pro' },
  { id: 'A23', name: 'ESG Compass' },
  { id: 'A24', name: 'HeirGuard' },
  { id: 'A25', name: 'Data & AI Safety' },
  { id: 'A26', name: 'The Oracle' },
